...
namespace ExpenseTrackingApp.Views
{
    ...
    public partial class AllTranscationsPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            //var foodExpenseGroup = new List<Expense>() ;
            //var automobileExpenseGroup = new List<Expense>();
            //var medicalExpenseGroup = new List<Expense>() ;
            //var utilitiesExpenseGroup = new List<Expense>();
            //var rentExpenseGroup = new List<Expense>();
            //var miscExpenseGroup = new List<Expense>();
        ...
        public ExpenseType GetExpenseType(string value)
        {
            ExpenseType ex;
            ...
            switch (value)
            {
                case "Food":
                    ...
                    break;
                case "Automobile":
                    ex = ExpenseType.Automobile;
                    break;
                case "Medical":
                    ex = ExpenseType.Medical;
                    break;
                case "Utilities":
                    ex = ExpenseType.Utilities;
                    break;
                case "Rent":
                    ex = ExpenseType.Rent;
                    break;
